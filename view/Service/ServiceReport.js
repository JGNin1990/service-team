...
import {
    fetch_all_withdrawals,
    fetch_fetbox,
    fetch_fatbox_ports,
    killfatboxport,
} from '../../src/redux/WithDrawalReducer';
...
const ServiceReport = props => {
    ...
    const task_status = ['complete', 'pending', 'other'];
    ...
    return (
        <ScrollView style={{flex: 1, backgroundColor: 'white'}}>
            <View
                ...
                <Field
                    editable
                    teamname={props.route.params.get_client.team_admin.name}
                ...
                <Field
                    editable
                    cust_name={
                        props.route.params.get_client.customer_data.first_name +
                        '-' +
                        props.route.params.get_client.customer_data.last_name
                    }
                ...
                <Field
                    ...
                    component={CustomTextInput}
                    editable
                    customerno={props.route.params.get_client.customer_no}
                />
                <Field
                ...
                <Field
                    placeholder="FAT Port TX"
                    formname
                    name="fat_port_tx"
                    component={CustomTextInput}
                />
                <Field
                    placeholder="Customer RX"
                    formname
                    name="customer_rx"
                    component={CustomTextInput}
                />
                <Field
                    placeholder="ONU Loss"
                    formname
                    name="onu_loss"
                    component={CustomTextInput}
                />
                ...
                <View
                    ...
                    <Field
                        ...
                        fun_newinstall={get_newinstallation}
                        data={newinstall_data}
                    />
                </View>
                ...
                <View
                    ...
                    <Field
                        component={RadioSelect}
                        name="installation"
                        fun_newinstall={get_installtiion}
                        data={install_data}
                    />
                </View>

                <Field
                    placeholder="Complain Ticket Number"
                    formname
                    name="complain_ticket_no"
                    component={CustomTextInput}
                />
                ...
                <Field
                    ...
                    all_withdrawals_result={task_status}
                    serviceui
                ...
                <Text
                    ...
                    Fill out if You selected task status other{' '}
                </Text>
                <Field
                    name="text_box"
                    component={CustomTextInput}
                ...
                <View
                    ...
                    <Field
                        ...
                        showdate_picker={datePicker}
                        name="arrival_date"
                    />

                    <Field
                        component={TimePicker}
                        press_show_time={showTimePicker}
                        show_time={timePicker}
                        time_selected={onTimeSelected}
                        get_time={time}
                        name="arrival_time"
                    />
                </View>
                ...
                <View
                    ...
                    <Field
                        component={DatePicker}
                        pickup_date={completedate}
                        date_selected={onCompletedDateSelected}
                        pressshowdate={showCompleteDatePicker}
                        showdate_picker={completedatepicker}
                        name="complete_date"
                    />

                    <Field
                        component={TimePicker}
                        press_show_time={showCompleteTimepicker}
                        name="complete_time"
                        show_time={completetimepicker}
                        time_selected={onCompleteTimeSelected}
                        get_time={completetime}
                    />
                </View>

                <Field
                    name="equipment_installed_replaced"
                    component={CustomTextInput}
                    placeholder="Equipment Installed/ Replaced"
                />
                ...
                <Field
                    name="serial_no"
                    component={SelectDropdownUI}
                    all_withdrawals_result={
                        newArr.length > 0 ? newArr : no_data
                    }
                    serviceui
                ...
                <Field
                    name="service_engineer_cmt"
                    component={CustomTextInput}
                    placeholder="Service Engineer Comment"
                    Remark={'Remark'}
                    multiple
                />
                ...
                <Field
                    name="service_complete_testing"
                    component={CustomTextInput}
                    placeholder="Service Complete Testing"
                    Remark={'Remark'}
                    multiple
                />
