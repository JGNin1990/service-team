            ...
            <View
                ...
                <View style={{alignItems: 'center', bottom: 15}}>
                    <Text
                        ...
                        {props.team_member && props.team_member.name}
                    </Text>
                    <Text
                        style={{
                            color: '#302A68',
                        ...
                        {props.team_member && props.team_member.email}
                    </Text>
                </View>
            </View>
            ...
            <View style={{flex: 1}}>
                ...
                <View
                    ...
                    <View style={{marginTop: 50}}>
                        ...
                        <TouchableOpacity
                            onPress={() =>
                                props.navigation.navigate('User Guide')
                            }>
                            <View
                                style={{
                                    flexDirection: 'row',
