...
const HomeScreen = props => {
    ...
    const filtredcount =
        props.maintain_list &&
        props.loged_user &&
        props.maintain_list.filter(value => value.status == 3);
    const filteredinstallcounnt =
        props.all_client_list &&
        props.loged_user &&
        props.all_client_list.filter(
            value =>
                value.approved_by_service_admin ==
                    props.loged_user.service_team_admin_id &&
                value.service_status == 3,
        );

    const allcolor = ['#CA9ADB', '#AA66BB', '#409ACD', '#38C1B9'];
    return (
        <View
            style={{
                flex: 1,
            ...
            <View
                style={{
                    ...
                    borderBottomLeftRadius: height / 9.7,
                }}>
                <View
                    style={{
                        flexDirection: 'row',
                ...
                <View style={styles.headtitlecontainer}>
                    <View style={{marginLeft: width / 90, width: '49%'}}>
                        <Text style={styles.titleconatiner}>
                            Hi, {props.loged_user && props.loged_user.name}
                        </Text>
                    ...
                    <View
                        ...
                        <View style={styles.subcardtitle}>
                            ...
                            <Text style={styles.subtitle}>
                                {filteredinstallcounnt &&
                                    filteredinstallcounnt.length}{' '}
                                tasks Pending
                            </Text>
                        </View>
                        <View style={styles.subcardtitle}>
                            ...
                            />
                            <Text style={styles.subtitle}>
                                {filtredcount && filtredcount.length} maintain
                                Pending
                            </Text>
                        </View>
                    </View>
            ...
            <View style={{flex: 1}}>
                ...
                <View
                    ...
                    <View
                        ...
                        <TouchableOpacity
                            onPress={() =>
                                props.navigation.navigate('Maintain List')
                            }>
                    ...
                    <View
                        ...
                        <TouchableOpacity
                            onPress={() =>
                                props.navigation.navigate('Service List')
                            }>
                            <Text style={styles.viewstyle}>View All</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <ScrollView
                        style={{flex: 1, backgroundColor: 'white', bottom: 10}}>
                        {filteredinstallcounnt &&
                        filteredinstallcounnt.length > 0 ? (
                            filteredinstallcounnt.map((val, index) => {
                                return (
                                    <View
                                        key={index}
                                        style={{
