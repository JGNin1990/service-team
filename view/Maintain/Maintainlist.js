...
const MaintainScreen = props => {
    ...
    const filtered_data =
        props.maintainlist &&
        props.maintainlist.filter(
            value =>
                value.status == 3 &&
                props.loged_userlist.service_team_admin_id ==
                    value.service_team_admin,
        );
                ...
                <View
                    ...
                    <View>
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                navigation.navigate('Maintain List Detail', {
                                    params: item,
                                    teamadmin_id:
                                        props.loged_userlist
...
const CompletedScreen = props => {
    const navigation = useNavigation();
    const filtered_completeddata =
        props.completelist &&
        props.completelist.filter(
            value =>
                value.status == 4 &&
                props.loged_userlist.service_team_admin_id ==
                    value.service_team_admin,
                ...
                <View
                    ...
                    <View>
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                navigation.navigate('Maintainhistory', item)
                            }>
    ...
    const filtered_data = rejected_client.reject_data.filter(
        val =>
            val.service_team_admin_id ==
                rejected_client.loged_userlist.service_team_admin_id &&
            val.status == 2 &&
            val.report_type == 1,
    );
                ...
                <View
                    ...
                    <View>
                        <TouchableOpacity
                            ...
                            onPress={() =>
                                navigation.navigate('editmaintain', item)
                            }>
                            <Text style={{color: 'white', fontSize: 11}}>
                                Edit
                            </Text>
    ...
    return (
        <View style={{flex: 1, backgroundColor: 'white'}}>
            ...
            <Tab.Navigator
                ...
                <Tab.Screen name="Maintain Lists">
                    {() => (
                        <MaintainScreen
                            loged_userlist={props.loged_user}
                            maintainlist={props.maintain_list}
                        />
                    )}
                </Tab.Screen>
                ...
                <Tab.Screen name="Reject List">
                    {() => (
                        <RejectScreen
                            reject_data={props.all_service_list}
                            loged_userlist={props.loged_user}
                        />
                    )}
                </Tab.Screen>
                <Tab.Screen name="Complete List">
                    {() => (
                        <CompletedScreen
                            completelist={props.maintain_list}
                            loged_userlist={props.loged_user}
                        />
                    )}
                </Tab.Screen>
