                ...
                <View style={{marginTop: 40}}>
                    <View
                        ...
                        <Text
                            ...
                            {props.memberdetail.service_admin.name}
                        </Text>
                    </View>
                    ...
                    <View
                        ...
                        <Text
                            ...
                            {props.memberdetail.service_admin.phone}{' '}
                        </Text>
                    </View>
                    ...
                    <View
                        ...
                        <Text
                            ...
                            {props.memberdetail.service_admin.email}{' '}
                        </Text>
                    </View>
                </View>
            </View>
        ...
        <View style={{backgroundColor: 'white', height: '100%'}}>
            ...
            <View style={{flex: 1, marginTop: 20}}>
                <Tab.Navigator
                    ...
                    <Tab.Screen name="Member Detail">
                        {() => <MemenerDetail memberdetail={service_list} />}
                    </Tab.Screen>
                    <Tab.Screen name="Admin Detail">
                        {() => <AdminDetail memberdetail={service_list} />}
                    </Tab.Screen>
                </Tab.Navigator>
            </View>
        </View>
